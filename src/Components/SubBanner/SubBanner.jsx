...
const SubBanner = ({heading, banner}) => {
    return (
        <div className='w-full px-4 relative '>
            <img className='w-full' src={banner || banner1} alt="" />
            <div className=' text-[#151515] text-center  px-12 absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full'>
                <div className='bg-black bg-opacity-40 text-white py-20'>
                <h1 className='text-3xl uppercase mb-4'>{heading}</h1>
