...
const Featured = () => {
    return (
        <div className="bg-featured-image bg-fixed text-white py-12">
            <SectionTitles headings={'From Our Menu'} subheadings={'Check it out'} />
            <div className="flex mt-12 mb-12 gap-6 items-center justify-center bg-black bg-opacity-40">
            ...
            <div className="space-y-4 ">
                ...
                <button className="btn btn-outline border-0 border-b-2 text-white font-bold text-xl">Read More</button>
            </div>
            </div>
        </div>
    );
